...
class Scan_area:
    ...
    def route_transformation(self, first_node, second_node, angle_rotation, start_point, height, intersection_ratio,
        ...
        self.edges = e1
        self.nodes = d1
        new_route_1, _ = self.create_route(start_point, height, intersection_ratio, False, angle_rotation, e1[0][0],
                                           e1[0][1])
        self.edges.clear()
        self.nodes.clear()
        self.edges = e2
        self.nodes = d2
        new_route_2, _ = self.create_route(start_point, height, intersection_ratio, False, angle_rotation, e2[0][0],
                                           e2[0][1])
        back_up_route = []
