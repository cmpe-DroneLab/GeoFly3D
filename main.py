...
height = 15  # Scanning resolution
intersection_ratio = 0.8  # The intersection_ratio is configurable
angle = (math.pi * 15 / 180)
#################################### Sample polygon
# node_1 = Node(29.043976, 41.086989, 0)
# node_2 = Node(29.044483, 41.086963, 0)
# node_3 = Node(29.044383, 41.086492, 0)
# node_4 = Node(29.043997, 41.086536, 0)
...
take_off_node = Node(29.043, 41.086, 0)
