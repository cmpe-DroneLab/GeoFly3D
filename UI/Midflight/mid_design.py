...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.horizontalLayout.addWidget(self.btn_take_off)
    ...
    def retranslateUi(self, Form):
        ...
        self.btn_return_back.setText(_translate("Form", "LAND DRONE"))
        self.btn_take_off.setText(_translate("Form", "RETURN TO HOME"))
