...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.btn_edit_mission = QtWidgets.QPushButton(parent=self.gb_missions)
        self.btn_edit_mission.setEnabled(False)
        self.btn_edit_mission.setObjectName("btn_edit_mission")
        self.h_lay_drone_buttons.addWidget(self.btn_edit_mission)
        self.verticalLayout_2.addLayout(self.h_lay_drone_buttons)
        self.v_lay_left.addWidget(self.gb_missions)
        self.btn_create_mission = QtWidgets.QPushButton(parent=Form)
        self.btn_create_mission.setObjectName("btn_create_mission")
        self.v_lay_left.addWidget(self.btn_create_mission)
