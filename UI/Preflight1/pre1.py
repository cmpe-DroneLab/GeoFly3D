...
class Pre1(QWidget):
    ...
    def create_test_missions(self):
        ...
        test_mission_1 = Mission(
            creation_time=get_current_time(),
            last_update_time=get_current_time(),
            center_lat=41.0854276,
            center_lon=29.0406022,
            gcs_lat=41.085089,
            gcs_lon=29.040599,
            coordinates="[[41.085344, 29.040127], [41.085148, 29.041186], [41.085556, 29.041315], [41.085746, 29.040256], [41.085344, 29.040127]]",
            mission_status="Draft",
        ...
        test_mission_2 = Mission(
            ...
            center_lon=29.0404322,
            gcs_lat=41.085089,
            gcs_lon=29.040599,
            coordinates="[[41.085273, 29.040307], [41.085148, 29.040999], [41.085598, 29.041143], [41.085718, 29.040454], [41.085273, 29.040307]]",
            mission_status="Draft",
            required_battery_capacity=0,
            selected_area=4087,
            altitude=20,
