...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.slider_altitude.setMaximum(200)
        self.slider_altitude.setSingleStep(5)
        ...
        self.gridLayout_2.addWidget(self.slider_altitude, 3, 2, 1, 1)
        self.slider_gimbal = QtWidgets.QSlider(parent=self.gb_resolution)
        self.slider_gimbal.setMinimum(-90)
        self.slider_gimbal.setMaximum(0)
        self.slider_gimbal.setSingleStep(5)
        self.slider_gimbal.setProperty("value", -90)
        self.slider_gimbal.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.slider_gimbal.setObjectName("slider_gimbal")
        self.gridLayout_2.addWidget(self.slider_gimbal, 4, 2, 1, 1)
        self.label_gimbal_angle = QtWidgets.QLabel(parent=self.gb_resolution)
        self.label_gimbal_angle.setObjectName("label_gimbal_angle")
        self.gridLayout_2.addWidget(self.label_gimbal_angle, 4, 0, 1, 1)
        self.label_altitude = QtWidgets.QLabel(parent=self.gb_resolution)
        self.label_altitude.setObjectName("label_altitude")
        self.gridLayout_2.addWidget(self.label_altitude, 3, 0, 1, 1)
        self.label_flight_parameters = QtWidgets.QLabel(parent=self.gb_resolution)
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        ...
        self.gridLayout_2.addWidget(self.label_flight_parameters, 0, 0, 1, 4)
        ...
        self.gridLayout_2.addWidget(self.spinbox_altitude, 3, 1, 1, 1)
        self.spinbox_gimbal = QtWidgets.QSpinBox(parent=self.gb_resolution)
        ...
        self.gridLayout_2.addWidget(self.spinbox_gimbal, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.batt_required_unit, 6, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.mission_time_unit, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.batt_provided_value, 7, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.mission_time_value, 3, 1, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_gimbal_angle.setText(_translate("Form", "Gimbal \n"
" Angle"))
